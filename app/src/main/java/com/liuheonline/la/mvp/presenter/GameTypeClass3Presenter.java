 ...
 * @description 玩法列表
 */
public class GameTypeClass3Presenter extends BasePresenter<BaseView<List<GameTypeClass3Entity>>>{
    ...
    public void getGameTypeClaa(int sid){
        ...
        mSubscription = RetrofitFactoryUtil.getRetrofit(LiuHeApplication.getQuickline())
                ...
                .getGameTypeClass3(sid)
                .compose(SetThread.io_main())
                .subscribe(new BaseConsumer<List<GameTypeClass3Entity>>() {
                    @Override
                    protected void onSuccees(BaseEntity<List<GameTypeClass3Entity>> t) throws Exception {
