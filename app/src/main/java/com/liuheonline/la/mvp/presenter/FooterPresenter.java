 ...
 */
public class FooterPresenter extends BasePresenter<BaseView<List<FooterEntity>>> {
     ...
     * @return void
     */
    public void getFooter(int year,int p,int row,int sid){
        ...
        mSubscription = RetrofitFactoryUtil.getRetrofit(LiuHeApplication.getQuickline())
                ...
                .getFooter(map)
                .compose(SetThread.<BaseEntity<List<FooterEntity>>>io_main())
                .subscribe(new BaseConsumer<List<FooterEntity>>() {
                    @Override
                    protected void onSuccees(BaseEntity<List<FooterEntity>> t) throws Exception {
