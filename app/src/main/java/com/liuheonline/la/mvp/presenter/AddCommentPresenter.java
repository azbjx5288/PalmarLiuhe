 ...
 * @description 新增评论
 */
public class AddCommentPresenter extends BasePresenter<BaseView<CommentEntity>>{

    public void addComment(String content,int itemId){
        getView().onLoading();
        mSubscription = RetrofitFactoryUtil.getRetrofit(LiuHeApplication.getQuickline())
                .getApiService(IForumServer.class)
                .addComment(content,itemId)
