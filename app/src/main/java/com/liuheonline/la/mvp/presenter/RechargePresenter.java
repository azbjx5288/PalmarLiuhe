 ...
 * @description
 */
public class RechargePresenter extends BasePresenter<BaseView<RechargeEntity>> {
    ...
    public void recharge(Map<String,Object> map){
        ...
        mSubscription = RetrofitFactoryUtil.getRetrofit(LiuHeApplication.getQuickline())
                ...
                .recharge(map)
                .compose(SetThread.<BaseEntity<RechargeEntity>>io_main())
                .subscribe(new BaseConsumer<RechargeEntity>() {
                    @Override
                    protected void onSuccees(BaseEntity<RechargeEntity> t) throws Exception {
