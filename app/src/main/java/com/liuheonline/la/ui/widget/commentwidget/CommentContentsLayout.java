...
import static com.liuheonline.la.ui.widget.commentwidget.CommentContentsLayout.ExpandState.COLLAPSED;
import static com.liuheonline.la.ui.widget.commentwidget.CommentContentsLayout.ExpandState.COLLAPSING;
import static com.liuheonline.la.ui.widget.commentwidget.CommentContentsLayout.ExpandState.EXPANDED;
import static com.liuheonline.la.ui.widget.commentwidget.CommentContentsLayout.ExpandState.EXPANDING;
...
public class CommentContentsLayout extends LinearLayout implements ViewGroup.OnHierarchyChangeListener {
    ...
    private int showMoreTextHeight = Dip2pxUtil.dip2px(getContext(),24f);
    private int commentLeftAndPaddintRight = Dip2pxUtil.dip2px(getContext(),8f);
    private int commentTopAndPaddintBottom = Dip2pxUtil.dip2px(getContext(),3f);
    ...
    private void initPaint() {
        if (mTextPaint == null) {
            ...
            mTextPaint.setTextSize(Dip2pxUtil.dip2px(getContext(),12f));
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawWrapButton()) {
            ...
            canvas.drawText(isExpanded() ? "收起评论" : "展开评论", (mDrawRect.width() - textWidth) / 2, mDrawRect.bottom - getPaddingBottom() - Dip2pxUtil.dip2px(getContext(),8f), mTextPaint);
            mMoreButtonTouchRect.set(mDrawRect.left,
                    mDrawRect.bottom - getPaddingBottom() - Dip2pxUtil.dip2px(getContext(),16f),
                    mDrawRect.right,
                    mDrawRect.bottom);
        }
    }
