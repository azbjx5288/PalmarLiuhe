...
public class FragmentPropertyFive extends BaseMvpFragment<BaseView<List<PropertiyEntity>>,PropertyPresenter,List<PropertiyEntity>> {
    ...
    public void successed(List<PropertiyEntity> propertiyEntities) {
        baseQuickAdapter.setNewData( propertiyEntities.get(2).get_child());
