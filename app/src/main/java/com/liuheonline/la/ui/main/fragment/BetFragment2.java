...
import com.liuheonline.la.ui.bet.BetLottery2Activity;
 ...
 * @description 投注
 */
public class BetFragment2 extends BaseMvpFragment<BaseView<List<LotteryCategoryEntity>>,
    ...
    public static BetFragment2 newInstance(int id) {
        Bundle args = new Bundle();
        args.putInt("id", id);
        BetFragment2 fragment = new BetFragment2();
    ...
    protected void initData() {
        baseViewHolderBaseQuickAdapter = new BaseQuickAdapter<LotteryCategoryEntity, BaseViewHolder>(R.layout.item_bet2) {
            @Override
            protected void convert(BaseViewHolder helper, LotteryCategoryEntity item) {
                ...
                helper.itemView.setOnClickListener(v -> {
                    if (SharedperfencesUtil.getInt(mContext, "userId") == 0) {
                        ...
                        startActivity(BetLottery2Activity.class, bundle);
                    }
                });
                if (!isLinear) {
                    ...
                    if (lotteryBean != null) {
                        ...
                        helper.setText(R.id.number06, strs[5]);
                        helper.setText(R.id.number07, strs[6]);
                        helper.setText(R.id.number08, strs[7]);
                        helper.setText(R.id.number09, strs[8]);
                        helper.setText(R.id.number10, strs[9]);

                        helper.setBackgroundRes(R.id.number01, LotteryTypeUtil.getBallBG(strs[0]))
                                .setBackgroundRes(R.id.number02, LotteryTypeUtil.getBallBG(strs[1]))
                                .setBackgroundRes(R.id.number03, LotteryTypeUtil.getBallBG(strs[2]))
                                .setBackgroundRes(R.id.number04, LotteryTypeUtil.getBallBG(strs[3]))
                                .setBackgroundRes(R.id.number05, LotteryTypeUtil.getBallBG(strs[4]))
                                .setBackgroundRes(R.id.number06, LotteryTypeUtil.getBallBG(strs[5]))
                                .setBackgroundRes(R.id.number07, LotteryTypeUtil.getBallBG(strs[6]))
                                .setBackgroundRes(R.id.number08, LotteryTypeUtil.getBallBG(strs[7]))
                                .setBackgroundRes(R.id.number09, LotteryTypeUtil.getBallBG(strs[8]))
                                .setBackgroundRes(R.id.number10, LotteryTypeUtil.getBallBG(strs[9]));
                        ...
                        if (lotteryCategoryEntity.getId() == sid) {
                            if (lotteryCategoryEntity.getLottery().getPeriods() == issue) {
                               ...
                               /* //由于彩种都在一个接口，这里排除掉 六合彩 的彩种
                                ...
                                BetFragment2.this.lotteryCategoryEntities = lotteryCategoryEntities;
